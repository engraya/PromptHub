  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
      <div className="max-w-lg flex-col gap-y-8">
        ...
        <p className="mt-4 text-gray-600 dark:text-gray-500 text-lg">aiPrompts is an innovative open-source web application designed to unleash your creativity. By leveraging the power of AI, aiPrompts allows users to generate, customize, and share unique prompts for a wide range of creative projects. Whether you are a writer seeking inspiration, a marketer in need of fresh ideas, or a developer looking for new challenges, aiPrompts has something for everyone..</p>
        </div>
