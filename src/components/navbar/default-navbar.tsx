...
export const DefaultNavbar = ({ mainNav }: DefaultNavbarProps) => {
  ...
  return (
    <section className="w-full flex md:justify-evenly md:items-center py-1">
      ...
      <Link
        href="/"
        className="md:hidden ml-1 flex justify-center items-center"
      >
        <Icons.logo />
        ...
        {mainNav.map((item, idx) => {
          return (
            <Link
              ...
              className={cn(
                "flex items-center text-lg font-medium dark:border-blue-500 border-emerald-600 hover:border-b-4 hover:border-emerald-600 rounde-b-md transition-colors hover:text-foreground/80 sm:text-sm",
