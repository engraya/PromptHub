  ...
  return (
      ...
      <div className="mb-8 flex justify-center">
        <p className="relative rounded-full px-4 py-1.5 text-sm leading-6 text-gray-600 ring-1 ring-inset ring-gray-900/10 hover:ring-gray-900/20">
          ...
          <a href="#" target="_blank" className="font-semibold text-lime-600">
            <span className="absolute inset-0" /> Clone
            the repo <span>→</span>
          </a>
    ...
    <div className="mt-2">
      <span className="relative mt-3 whitespace-nowrap text-blue-600"><svg aria-hidden="true" viewBox="0 0 418 42" className="absolute top-3/4 left-0 right-0 m-auto h-[0.58em] w-fit fill-pink-400/50" preserveAspectRatio="none">
        ...
        <span className="relative">with AI Prompts.</span>
      </span>
    </div>
  </h1>
        <p className="mt-6 text-lg leading-8 text-gray-600">
          Introducing our cutting-edge Sharing Solution, the ultimate area for prompts.
          Unlock your creativity with aiPrompts – the ultimate platform for generating, sharing, and discovering AI prompts for every need
        </p>
      </div>
